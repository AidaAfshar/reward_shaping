...
from reward_shaping.envs.highway_env_original.env_backend.vehicle.controller import MDPVehicle
...
class ActionType(object):
    ...
    def vehicle_class(self) -> Callable:
        ...
        Must return a subclass of :py:class:`highway_env_RSS.vehicle.kinematics.Vehicle`.
        """
        raise NotImplementedError
    ...
    def act(self, action: Action) -> None:
        ...
        vehicle is an instance of the specified :py:class:`highway_env_RSS.envs.common.action.ActionType.vehicle_class`.
